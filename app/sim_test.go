...
func BenchmarkSimulation(b *testing.B) {
	...
	bApp, err := app.New(logger, db, nil, true, app.DefaultNodeHome, appOptions, fauxMerkleModeOpt, baseapp.SetChainID(SimAppChainID))
...
func TestAppImportExport(t *testing.T) {
	...
	newApp, err := app.New(log.NewNopLogger(), newDB, nil, true, app.DefaultNodeHome, appOptions, fauxMerkleModeOpt, baseapp.SetChainID(SimAppChainID))
	require.NoError(t, err)
