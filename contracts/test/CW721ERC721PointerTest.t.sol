...
contract CW721ERC721PointerTest is Test {
    ...
    function testBalanceOf() public {
        vm.mockCall(
            ...
            abi.encodeWithSignature("query(string,bytes)", MockCWContractAddress, bytes("{\"tokens\":{\"limit\":1000,\"owner\":\"eni19zhelek4q5lt4zam8mcarmgv92vzgqd3ux32jw\"}}")),
            abi.encode("{\"tokens\":[\"a\",\"b\"]}")
        );
        vm.mockCall(
            WASMD_PRECOMPILE_ADDRESS,
            abi.encodeWithSignature("query(string,bytes)", MockCWContractAddress, bytes("{\"tokens\":{\"limit\":1000,\"owner\":\"eni19zhelek4q5lt4zam8mcarmgv92vzgqd3ux32jw\",\"start_after\":\"b\"}}")),
            abi.encode("{\"tokens\":[\"c\",\"d\"]}")
        );
        vm.mockCall(
            WASMD_PRECOMPILE_ADDRESS,
            abi.encodeWithSignature("query(string,bytes)", MockCWContractAddress, bytes("{\"tokens\":{\"limit\":1000,\"owner\":\"eni19zhelek4q5lt4zam8mcarmgv92vzgqd3ux32jw\",\"start_after\":\"d\"}}")),
            abi.encode("{\"tokens\":[]}")
        );
    ...
    function testOwnerOf() public {
        ...
        vm.mockCall(
            JSON_PRECOMPILE_ADDRESS,
            abi.encodeWithSignature("extractAsBytes(bytes,string)", bytes("{\"owner\":\"eni19zhelek4q5lt4zam8mcarmgv92vzgqd3ux32jw\"}"), "owner"),
            abi.encode(bytes("eni19zhelek4q5lt4zam8mcarmgv92vzgqd3ux32jw"))
        );
    ...
    function testGetApproved() public {
        vm.mockCall(
            ...
            abi.encode("{\"approvals\":[{\"spender\":\"eni1vldxw5dy5k68hqr4d744rpg9w8cqs54x4asdqe\"}]}")
        );
        bytes[] memory response = new bytes[](1);
        response[0] = bytes("{\"spender\":\"eni1vldxw5dy5k68hqr4d744rpg9w8cqs54x4asdqe\"}");
        vm.mockCall(
            JSON_PRECOMPILE_ADDRESS,
            abi.encodeWithSignature("extractAsBytesList(bytes,string)", bytes("{\"approvals\":[{\"spender\":\"eni1vldxw5dy5k68hqr4d744rpg9w8cqs54x4asdqe\"}]}"), "approvals"),
            abi.encode(response)
        );
        vm.mockCall(
            JSON_PRECOMPILE_ADDRESS,
            abi.encodeWithSignature("extractAsBytes(bytes,string)", bytes("{\"spender\":\"eni1vldxw5dy5k68hqr4d744rpg9w8cqs54x4asdqe\"}}"), "spender"),
            abi.encode(bytes("eni1vldxw5dy5k68hqr4d744rpg9w8cqs54x4asdqe"))
        );
    ...
    function testIsApprovedForAll() public {
        vm.mockCall(
            WASMD_PRECOMPILE_ADDRESS,
            abi.encodeWithSignature("query(string,bytes)", MockCWContractAddress, bytes("{\"all_operators\":{\"owner\":\"eni19zhelek4q5lt4zam8mcarmgv92vzgqd3ux32jw\"}}")),
            abi.encode("{\"operators\":[{\"spender\":\"eni1vldxw5dy5k68hqr4d744rpg9w8cqs54x4asdqe\"}]}")
        );
        bytes[] memory response = new bytes[](1);
        response[0] = bytes("{\"spender\":\"eni1vldxw5dy5k68hqr4d744rpg9w8cqs54x4asdqe\"}");
        vm.mockCall(
            JSON_PRECOMPILE_ADDRESS,
            abi.encodeWithSignature("extractAsBytesList(bytes,string)", bytes("{\"operators\":[{\"spender\":\"eni1vldxw5dy5k68hqr4d744rpg9w8cqs54x4asdqe\"}]}"), "operators"),
            abi.encode(response)
        );
        vm.mockCall(
            JSON_PRECOMPILE_ADDRESS,
    ...
    function testTransferFrom() public {
        vm.mockCall(
            WASMD_PRECOMPILE_ADDRESS,
            abi.encodeWithSignature("query(string,bytes)", MockCWContractAddress, bytes("{\"owner_of\":{\"token_id\":\"1\"}}")),
            abi.encode("{\"owner\":\"eni1vldxw5dy5k68hqr4d744rpg9w8cqs54x4asdqe\"}")
        );
        vm.mockCall(
            JSON_PRECOMPILE_ADDRESS,
            abi.encodeWithSignature("extractAsBytes(bytes,string)", bytes("{\"owner\":\"eni1vldxw5dy5k68hqr4d744rpg9w8cqs54x4asdqe\"}"), "owner"),
            abi.encode(bytes("eni1vldxw5dy5k68hqr4d744rpg9w8cqs54x4asdqe"))
        );
        vm.mockCall(
            ADDR_PRECOMPILE_ADDRESS,
        ...
        vm.mockCall(
            WASMD_PRECOMPILE_ADDRESS,
            abi.encodeWithSignature("execute(string,bytes,bytes)", MockCWContractAddress, bytes("{\"transfer_nft\":{\"recipient\":\"eni1vldxw5dy5k68hqr4d744rpg9w8cqs54x4asdqe\",\"token_id\":\"1\"}}"), bytes("[]")),
            abi.encode(bytes(""))
        );
        vm.startPrank(0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266);
        //vm.expectEmit();
    ...
    function testApprove() public {
        vm.mockCall(
            WASMD_PRECOMPILE_ADDRESS,
            abi.encodeWithSignature("execute(string,bytes,bytes)", MockCWContractAddress, bytes("{\"approve\":{\"spender\":\"eni1vldxw5dy5k68hqr4d744rpg9w8cqs54x4asdqe\",\"token_id\":\"1\"}}"), bytes("[]")),
            abi.encode(bytes(""))
        );
        vm.mockCall(
            WASMD_PRECOMPILE_ADDRESS,
    ...
    function testSetApprovalForAll() public {
        vm.mockCall(
            WASMD_PRECOMPILE_ADDRESS,
            abi.encodeWithSignature("execute(string,bytes,bytes)", MockCWContractAddress, bytes("{\"approval_all\":{\"operator\":\"eni1vldxw5dy5k68hqr4d744rpg9w8cqs54x4asdqe\"}}"), bytes("[]")),
            abi.encode(bytes(""))
        );
        vm.startPrank(0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266);
        //vm.expectEmit();
    ...
    function testSetRevokeForAll() public {
        vm.mockCall(
            WASMD_PRECOMPILE_ADDRESS,
            abi.encodeWithSignature("execute(string,bytes,bytes)", MockCWContractAddress, bytes("{\"revoke_all\":{\"operator\":\"eni1vldxw5dy5k68hqr4d744rpg9w8cqs54x4asdqe\"}}"), bytes("[]")),
            abi.encode(bytes(""))
        );
        vm.startPrank(0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266);
        //vm.expectEmit();
