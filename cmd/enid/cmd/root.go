...
import (
	...
	"github.com/eni-chain/go-eni/tools"
...
func addModuleInitFlags(startCmd *cobra.Command) {
	...
	startCmd.Flags().Bool("migrate-iavl", false, "Run migration of IAVL data store to EniDB State Store")
