...
func (k *Keeper) getEvmGasLimitFromCtx(ctx sdk.Context) uint64 {
	...
	evmGasBig := sdk.NewDecFromInt(sdk.NewIntFromUint64(eniGasRemaining)).Quo(k.GetPriorityNormalizer(ctx.WithGasMeter(sdk.NewInfiniteGasMeterWithMultiplier(ctx)))).TruncateInt().BigInt()
