...
replace (
	...
	github.com/cometbft/cometbft => github.com/eni-chain/eni-cometbft v0.0.0-20251206180318-2e4c6fcbaf85
	github.com/cosmos/cosmos-sdk => github.com/eni-chain/eni-cosmos v0.0.0-20251020135324-8ffabfe6d8ce
