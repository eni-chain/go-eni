...
import (
	...
	github_com_sei_protocol_sei_chain_x_evm_derived "github.com/eni-chain/go-eni/x/evm/derived"
...
type MsgEVMTransaction struct {
	...
	Derived *github_com_sei_protocol_sei_chain_x_evm_derived.Derived `protobuf:"bytes,2,opt,name=derived,proto3,customtype=github.com/eni-chain/go-eni/x/evm/derived.Derived" json:"derived,omitempty"`
}
