...
INPUT=$(forge create -r "$evm_endpoint" --private-key dc9bb398d00f7778a61dcbb7e90cfe527b7e7b69ce9d557a08d5e32ea8d3eac0 src/NoopToken.sol:NoopToken --json --constructor-args "NoopToken" "NT" | jq -r '.transaction.input')

deploy_output=$(cast send --rpc-url http://localhost:8545 --private-key  dc9bb398d00f7778a61dcbb7e90cfe527b7e7b69ce9d557a08d5e32ea8d3eac0 --gas-limit 700000 --gas-price 200000 --create $INPUT --json)
...
cast call $contract_address "name()" $ACCOUNT --rpc-url "$evm_endpoint"
