...
import (
	...
	utils2 "github.com/ethereum/go-ethereum/trie/utils"
...
func (s *DBImpl) PointCache() *utils2.PointCache {
	//TODO implement me
	return utils2.NewPointCache(0)
}

func (s *DBImpl) Witness() *stateless.Witness {
	//TODO implement me
	return nil
}
...
func (s *DBImpl) AddSurplus(surplus cosmossdk_io_math.Int) {
...
func (s *DBImpl) Finalize() (surplus cosmossdk_io_math.Int, err error) {
	if s.simulation {
...
type TemporaryState struct {
	...
	surplus               cosmossdk_io_math.Int // in wei
}
