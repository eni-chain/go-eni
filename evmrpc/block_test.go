...
func verifyBlockResult(t *testing.T, resObj map[string]interface{}) {
	...
	require.Equal(t, "0x25c", resObj["size"])
	...
	require.Equal(t, "0x6afe5da51c30a0048678d21925856d544d936a0d06e3d2003c8ca547fd934bbc", tx["hash"])
	...
	require.Equal(t, "0x697873", tx["chainId"])
	require.Equal(t, "0x1", tx["v"])
	require.Equal(t, "0x5bbb1811614070bfa790b740be511c66f5bfead77bd1d7b0f990a72d4b7c0d20", tx["r"])
	require.Equal(t, "0x55fde9eed64c437fc0029200f496a84066c8724526046302c91965b69eadc127", tx["s"])
