# Eni Tools
This page provides an overview of a couple of built-in tools provided by enid command line. 
...
enid tools scan-tx --start-height 1 --state-dir ./ > scan.log &
```
...
the enid process before running the below command:
```
enid tendermint reindex-event --start-height 2124542 --end-height 2124543
```
