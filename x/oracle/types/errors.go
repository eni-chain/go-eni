...
var (
	...
	ErrParsingOracleQuery    = sdkerrors.Register(ModuleName, 18, "Error parsing EniOracleQuery")
	...
	ErrUnknownEniOracleQuery = sdkerrors.Register(ModuleName, 23, "Error unknown eni oracle query")
