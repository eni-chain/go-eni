...
var (
	...
	ErrParsingEniTokenFactoryQuery    = sdkerrors.Register(ModuleName, 15, "Error parsing EniTokenFactoryQuery")
	...
	ErrUnknownEniTokenFactoryQuery    = sdkerrors.Register(ModuleName, 23, "Error unknown eni token factory query")
