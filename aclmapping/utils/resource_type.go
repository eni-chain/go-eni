...
var StoreKeyToResourceTypePrefixMap = aclsdktypes.StoreKeyToResourceTypePrefixMap{
	...
	evmtypes.StoreKey: {
		...
		aclsdktypes.ResourceType_KV_EVM_S2E:               evmtypes.EniAddressToEVMAddressKeyPrefix,
		aclsdktypes.ResourceType_KV_EVM_E2S:               evmtypes.EVMAddressToEniAddressKeyPrefix,
